...
#include "Layer.h"
	...
	void destroy();
	extern inline unsigned int ARGB(unsigned int a,unsigned int r,unsigned int g,unsigned int b);
	extern inline unsigned int tRGB(unsigned int r,unsigned int g,unsigned int b);
	extern inline unsigned int getColor(Layer& id, int x, int y);
	extern inline void RGBt(unsigned int color, unsigned int *r,unsigned int *g,unsigned int *b);
	extern inline void ARGBt(unsigned int color, unsigned int *a, unsigned int *r,unsigned int *g,unsigned int *b);
	extern inline void RGBt(unsigned int color, int *r, int *g, int *b);
	extern inline void ARGBt(unsigned int color, int *a, int *r, int *g, int *b);
	extern inline unsigned int At(unsigned int color);
	extern inline unsigned int tA(unsigned int color);
	extern inline unsigned int tA(unsigned int color);
	extern inline int getHeight(Layer& id);
	extern inline int getWidth(Layer& id);
	extern inline void reset(Layer& id);
	...
	extern inline void plot(Layer& id, int x,int y,unsigned int color);
	extern inline void plot(Layer& id, int x,int y,int r,int g,int b);
	void plot(Layer& id, int x,int y, int a, int r,int g,int b);
	extern inline void transparency(Layer& id,int x,int y, int a);
	...
	extern inline void MSDrawC(Layer& id, int x, int y, int a, int r, int g, int b, int mode);
